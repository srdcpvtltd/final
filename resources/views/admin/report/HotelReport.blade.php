                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td scope="col" style="display: flex; justify-content: space-between;">
                                <a href="{{ asset(url('/admin/hotel/detail/'.$row->id)) }}"><i class="fa fa-eye"></i></a>
                                <a href="{{ asset(url('/admin/hotel/update/'.$row->id)) }}"><i class="fa fa-pencil"></i></a>
                                <a onclick="return confirm('Are you sure?')" href="{{ asset(url('/admin/hotel/delete/'.$row->id)) }}" class="deleteHotel" data-id="{{$row->id}}" style="color:red;"><i class="fa fa-remove"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
